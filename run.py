...
def main(args):
    runtime_rank = tensorrt_llm.mpi_rank()  # 0
    logger.set_level(args.log_level)        # 'info'

    # different handling if encoder-decoder models
    is_enc_dec = {'encoder', 'decoder'}.issubset({  # False
        name
    ...
    model_name, model_version = read_model_name(            # model_name: LlamaForCausalLM; model_version: NONE
    ...
    tokenizer, pad_id, end_id = load_tokenizer(             # LlamaTokenizerFast
